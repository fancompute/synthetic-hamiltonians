...
def interact_bin_bin(bin1, bin2, κ, α, num_bosons, num_sites, use_ponomarev=True):
...
# def excise_register_bin(state_or_operator, num_bosons, num_sites, use_ponomarev=True, register_index=-1):
#     '''Returns the state or operator with the component representing the register time bin removed.'''
#     assert type(state_or_operator) is qt.Qobj
#
#     if state_or_operator.type == "ket":
#         state = state_or_operator
#
#
#     else:
#         op = state_or_operator
#
#     # TODO
